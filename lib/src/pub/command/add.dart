...
Specify multiple sdk packages with descriptors.''');
    ...
    return _PartialParseResult(
      ref ??
          PackageRef(
            ...
            HostedDescription(
              packageName,
              hostedUrl(argResults.hostedUrl),
            ),
          ),
      constraint,
    );
  ...
  /// Allows private package repositories to provide their hosted url
  /// instead of falling bakc to the [cache.hosted.defaultUrl]
  String hostedUrl(String? argsHostedUrl) =>
      argsHostedUrl ?? cache.hosted.defaultUrl;
